...
<div class="wrapper">
    ...
    <main>
        ...
        <section>
            ...
            <p class="quote" style="margin-left: 20px;">LATEST FROM OUR BLOG</p>
            <br>

            <?php
            /*Вывод описания блога*/
            $myrow = $info->conclusionBlog(3);
            /*Вывод описания блога конец*/
            ?>
            ...
            <div class="navigation">
                <ul>
                    ...
                    <li class="page">
                        <a href="blogPage2.php">2</a>
                    </li>
                    <li>
                        <a href="blogPage3.php">3</a>
                    </li>
                </ul>
            </div>
