...
<div class="wrapper">
    ...
    <main>
        ...
        <section>
            ...
            <p class="brand">CONTACT FORM</p>
            <br>


            <form class="form" method="post">

                <input class="nameForm1" name="name" type="text" placeholder="Your Name">
                <br>
                <br>
                <input class="email" name="email" type="text" placeholder="E-Mail Address">
                <br>
                <br>
                <textarea class="textArea" name="textArea" placeholder="Enter your text" cols="100"
                          rows="10"></textarea>
            ...
            <div class="map">
                ...
                <script type="text/javascript" charset="utf-8" async
                        src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Af004eb650e769ddb7abf1c063f266134979bcda77b4b34de63084490f9220291&amp;width=993&amp;height=755&amp;lang=ru_RU&amp;scroll=true"></script>

            </div>


            <p class="brand" style="margin-left: 20px;">Brand Logo</p>

            <ul class="brandLogo">
                <li>
                    <img src="img/brand/1.png" alt=""></li>
                <li>
                    <img src="img/brand/2.png" alt=""></li>
                <li>
                    <img src="img/brand/3.png" alt=""></li>
                <li>
                    <img src="img/brand/4.png" alt=""></li>
                <li>
                    <img src="img/brand/5.png" alt=""></li>
            </ul>
...
<footer style="margin: 1536px auto 0 auto">
